...
import project5 from '../assets/wordpress.png';
      ...
      <div>
        ...
        <WorkList>
          <Work>
            <Img src={project1} />
            <Layer>
              <h2>My Online Library</h2>
              <Description>A Full-stack MERN App that you can search for books by category, title or author.</Description>
          ...
          <Work>
            ...
            <Layer>
              ...
              <Description>A Full-stack MERN App for surfing the meals and get connected with cook (a live chat system).</Description>
          ...
          <Work>
            ...
            <Layer>
              ...
              <Description>A dynamic WordPress website using Elementor Pro.</Description>

              <a href="http://elementor24.infinityfreeapp.com/" target="_blank" rel="noreferrer">
                <FiExternalLink size={28} />
                <div>Demo</div>
              </a>
            </Layer>
          ...
          {/* <Work>
            ...
            <Layer>
              <h2>Dad Jokes </h2>
              <Description>A Dad Jokes Generator project with Feedback UI using HTML, CSS, and JavaScript.</Description>
          ...
          <Work>
            ...
            <Layer>
              ...
              <Description>A modern responsive react notes app</Description>
              <a href="https://github.com/Negar-La/React-Notes-App" target="_blank" rel="noreferrer">
                <AiOutlineGithub size={28} />
                <div>Code</div>
              </a>
              <a href="https://react-notes-app-8uii.onrender.com/" target="_blank" rel="noreferrer">
                <FiExternalLink size={28} />
                <div>Demo</div>
              </a>
            </Layer>
